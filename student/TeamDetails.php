...
<h2 class="sub-header">Teams Details</h2>
      ...
      $(document).ready(function () {
       ...
       var responseBody={};
		...
		function processResponse(responseBody) {
                ...
                rowDatahtml= rowDatahtml + "<td id='team_owner_id'>" + "</td>";
			...
			setProjectNameData();
            setTeamOwnerNameData(rowData["team_owner_id"]);
		};
        ...
        function processMembershipData(rowDatahtml, rowData) {
					...
					success: function (data) {
                       ...
                       if (rowData['members']) {
                       rowDatahtml = rowDatahtml + "<tr><td></td><td></td><td></td><td>Members:</td><td><ul>"; 
			...
			function setProjectNameData() {				
				 $.ajax({
					...
					//	console.log(data[1]['name']);
                  	...
                  	function setTeamOwnerNameData(owner_id) {				
				 $.ajax({
					// HTTP mthod
					type: "GET",
					url: "/TCP/WS/StudentResource.php?id=" +owner_id,
					// return type
					dataType: "json",					
					// error processing
					// xhr is the related XMLHttpRequest object
